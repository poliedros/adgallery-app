    ...
    return (
        <>
            <div className="overflow-auto smallScroll h-[66vh] shadow-xl py-2 border-2 border-slate-300">
                ...
                {ads ? (
                    ads.map((ad, i) => (
                        <Col key={i} className="flex items-center justify-center mx-3 my-1.5">
                        <Card
                        ...
                        >
                            <Card.Body>
                                ...
                                <div className="flex flex-column items-end">
                                    <CapBtn label="edit" iconType="ri" icon="RiEditBoxFill" css="!mb-0 -mr-[1rem]" click={() => editAd(ad._id)} />
                                    <CapBtn label="status" iconType="md" icon="MdCircle" css="!mb-1 -mr-[1rem]" click={() => statusAd(ad._id)} />
                                </div>
                                {/* <Card.Text>
