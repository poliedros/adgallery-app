...
export default function AgAdsFormat({adFormatProp, setAdFormatProp, adFormats}: {adFormatProp: any, setAdFormatProp: any, adFormats: AdFormatDTO[] | undefined}) {
    ...
    return (
        <>
            <div className="overflow-auto smallScroll h-[66vh] shadow-xl py-2 border-2 border-slate-300">
                    <Row className="mx-0">
                    {adFormats ? adFormats.map((af) => (
                        <Col key={af._id} className="flex items-center justify-center mx-3 my-1.5">
                        <Card
                        ...
                        >
                            <Card.Body>
                                ...
                                <Card.Text>
                                    {af.description} <br />
                                    {
                                        translantions.brazilianCurrencySign[
                                            "pt"
                                        ]
                                    }{" "}
                                    {af.amountCents / 100} <br />
                                    {translantions.scales["pt"]} {af.width} x{" "}
                                    {af.height}
                                </Card.Text>
